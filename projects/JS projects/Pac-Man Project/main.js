class Pacman extends Phaser.Scene {
    ...
    preload() {
    this.load.image("pacman-tiles", "pacman tiles/tileset.png");
    this.load.tilemapTiledJSON("map","pacman-map.json");
    this.load.spritesheet("pacman","pacman characters/pacman0.png",{
        frameWidth:32,frameHeight:32
    });
    this.load.spritesheet("pacman1","pacman characters/pacman1.png",{
        frameWidth:32,frameHeight:32
    });
    this.load.spritesheet("pacman2","pacman characters/pacman2.png",{
        frameWidth:32,frameHeight:32
    });
    this.load.spritesheet("pacman3","pacman characters/pacman3.png",{
        frameWidth:32,frameHeight:32
    });
    this.load.spritesheet("pacman4","pacman characters/pacman4.png",{
        frameWidth:32,frameHeight:32
    });
    ...
    const tileset = this.map.addTilesetImage("pacman-tiles");
